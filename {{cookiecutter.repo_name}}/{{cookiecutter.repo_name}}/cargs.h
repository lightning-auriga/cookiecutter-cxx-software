...
{%- if cookiecutter.require_boost_program_options %}
...
namespace {{ cookiecutter.repo_name }} {
  ...
  public:
     ...
     */
    bool requests_gzip() const {
      return compute_flag("gzip");
    }
    /*!
     ...
     */
    bool requests_bzip2() const {
      return compute_flag("bzip2");
    }
    /*!
    ...
    /*!
      ...
      \warning this is only used in merge mode. it is ignored in initial analysis mode.
     */
    ...
    /*!
      \brief determine whether the user wants chip variants removed from output files
      \return whether the user wants chip variants removed from output files
     */
     ...
     */
    bool get_merge_mode() const {
      return compute_flag("merge-mode");
    }
    ...
    /*!
      \brief get the optional list of variants to include for set 1 during the merge
      \return specified file, or "" if none specified
    ...
    /*!
      \brief get the optional list of variants to include for set 2 during the merge
      \return specified file, or "" if none specified
